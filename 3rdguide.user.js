...
(function() {
    ...
    const translate = function() {
        $('.table-s-a li, .table-s-b').each(function() {
            tl_el(tls.misc, this)
        })

        $('#_js_table_s_c li').each(function() {
            tl_el(tls.bosses, this)
        })

        $('#_js_table_s_d_1 li, #_js_table_s_d_1 div').each(function() {
            tl_el(tls.valkyries, this)
        })
    }
